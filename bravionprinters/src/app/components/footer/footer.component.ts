        ...
        <div class="footer-grid">
          ...
          <div class="footer-col">
            ...
            <ul class="footer-links">
              ...
              <li><a routerLink="/signage-branding">Signage & Shop</a></li>
              <li><a routerLink="/corporate-branding">Corporate Apparel</a></li>
              <li><a routerLink="/office-branding">Office Branding</a></li>
              <li><a routerLink="/event-branding">Event Branding</a></li>
              <li><a routerLink="/digital-design">Digital Design</a></li>
              <li><a routerLink="/printing-stationery">Printing & Stationery</a></li>
            </ul>
          </div>
          ...
          <div class="footer-col">
            ...
            <div class="contact-items">
              <div class="contact-item">
                ...
                <a href="tel:+254726612470">0726 612 470</a>
              </div>
              <div class="contact-item">
              ...
              <div class="contact-item">
                ...
                <span>Kilimani, Nairobi<br/>Opp. Rose Avenue Center,<br/>Behind Coptic Mission Hospital</span>
              </div>
            </div>
          </div>
        </div>
